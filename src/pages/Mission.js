...
const namesPL = ["Misja", "Uczestnicy", "Patronaty", "Komitet Organizacyjny", "Informacje Użytkowe", " Kontakt", " Formularz", "KONFERENCJA NAUKOWA", "CZY ZAWODY UI/UX TO ZAWODY PRZYSZŁOŚCI?","Misja","Naszą misją jest dyskusja na temat rozwoju UI/UX i stworzeniu rozwiązań wspomagających je w przyszłości. "]
const namesEN = ["Mission", "Guests", "Patrons", "Committee", "Info", "Contact", "Form", "SCIENTIFIC CONFERENCE", "ARE UI/UX JOBS OF THE FUTURE?","Mission","Our mission is to discuss the development of UI/UX and create solutions to support them in the future."]
